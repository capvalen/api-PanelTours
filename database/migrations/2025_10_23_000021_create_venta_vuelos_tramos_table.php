...
return new class extends Migration
{
    ...
    {
        Schema::create('venta_vuelos_tramos', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('equipaje')->nullable();
            ...
            $table->string('billete_electronico', 50)->nullable();
            $table->string('asientos_asignados', 200)->nullable();

            // Información adicional
            $table->enum('clase_vuelo', ['economica', 'economica_plus', 'ejecutiva', 'primera'])->default('economica');
            $table->boolean('escala')->default(false);
            $table->integer('numero_escala')->default(0);
    ...
    {
        Schema::dropIfExists('venta_vuelos_tramos');
    }
};
